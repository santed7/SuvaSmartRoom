...
int ms_sensor = 5;          // the pin that the motion sensor is atteched to
int button = 2;             // the pin that the button is a attached to
int state = LOW;            // by default, no motion detected

int ms_val;             // variable to store the motion sensor status (value)
int ms_state;           // variable to store the motion sensor cycles
int button_val;         // variable to store the button sensor status (value)
int count;              // variable to store total people counted since device was turned on or reset
int button_presses;
